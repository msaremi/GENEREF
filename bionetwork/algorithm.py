...
class Predictor:
    ...
    def _solve_subproblem_2(self, x, y, feature_weight=None):
...
#
#     @staticmethod
#     def _get_subproblem(experiment: Experiment, target_gene, alpha=None, importances=None):
#         x = np.delete(experiment.data, target_gene, axis=1)
#         y = experiment.data[:, target_gene:target_gene+1]
#         weights = None
#
...
#                 pred_network = Predictor._make_network(results)
#
#             penalty = WeightedNetwork(pred_network).get_redistributed_network().data
